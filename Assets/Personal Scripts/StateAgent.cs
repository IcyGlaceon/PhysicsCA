...
public class StateAgent : Agent
{
    ...
    void Start()
    {
       ...
       // stateMachine.AddState(new ChaseState(this));
        ...
        //stateMachine.AddTransition(nameof(ChaseState), new Transition(new Condition[] { enemySeenCondition, healthOkCondition }), nameof(AttackState));

        //stateMachine.AddTransition(nameof(WanderState), new Transition(new Condition[] { timerExpiredCondition }), nameof(IdleState));
        //stateMachine.AddTransition(nameof(WanderState), new Transition(new Condition[] { enemySeenCondition }), nameof(AttackState));
